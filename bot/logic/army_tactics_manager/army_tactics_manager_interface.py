"""
Army Tactics Manager
- assigns medium priority actions
- tells units to engage or disengage nearby enemy units
- so lets say we have 2 queens assigned to attack an oracle in the main base, but other one of the queens is already fighting against adepts at the nat. 
ArmyManager will tell the queen to engage the closest target and this will override the command from ArmyStrategyManager
